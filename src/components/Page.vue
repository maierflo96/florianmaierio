    ...
    <div>
      <md-divider></md-divider>
        <div class="md-layout md-gutter md-alignment-center">
          ...
          <h2> I'm a software developer based in Vienna, Austria. I have  been working as Java and JavaScript developer at a few major companies. For work I have been programming Java Spring Applications, as well as both Front- and Backend NodeJs Applications.
          ...
          <div class="md-layout-item md-medium-size-15 md-small-size-50 md-xsmall-size-100" >
            <img style=max-height:450px  src="../assets/octocat.png" />
          </div>
        </div>
